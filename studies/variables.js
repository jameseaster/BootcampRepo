...
*
* 1. To create a variable you use the keyword var and then are able
*    to assign it a value. Putting these two steps together is
*    called initialization. 
*
* 2. var is a keyword that is used in declaring a variable. It is
*    hoisted and it is reassignable. Var is not block-scoped.
* 
* 3. let - a keyword that is used in declaring a variable. Let is
...
* 
* 4. const - is also a keyword that is used when declaring a 
...
*    variable.
* 
* 5. Hoisting is a mechanism in JS where variables and function
