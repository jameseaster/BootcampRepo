...
// 1. Number //
/*
* Number - a primitive datatype of numeric data. A number can be
* placed into equations and executed following the order of 
* operations. A numeric expression is resolved before the line
* of code continues to execute. Numbers can also store negative
...
// 2. String //
/*
* String - a character or more of textual data. Strings are
...
// 3. Boolean //
/*
* Boolean - a true or false value. Booleans are very useful when
...
// 4. Array //
/*
* Arrays - a collection of any datatype stored as a list in
...
// 5. Object //
/*
* Objects - a collection of key/value pairs. While objects are 
...
// 6. Function //
/*
* Functions - a block of code designed to perform a particular 
...
// 7. undefined //
/*
* undefined - a primitive data type that is a variable that has
...
// 8. null //
/*
* null - is a primitive value and is treated as falsy for boolean
...
// 9. NaN //
/*
* NaN - a property value that is representing Not-A-Number. This
...
/*
* Infinity (and -Infinity) - a numeric value representing 
...
/* // By Copy //
* When a primitive datatype is assigned to a variable it is 
* actually held in that variable. If that variable is assigned
* to another variable the data is copied directly into the new 
* variable.
*/
    var num1 = 10;
