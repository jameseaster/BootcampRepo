...
* FUNCTIONS:
* 
* 0. A function is a small program that can be called by code
*    inside or outside of itself. A function is composed of
*    a code block that can take values, manipulate, and return
*    them. Functions can have methods and properties like any
*    other object. Functions, unlike objects, can be called.
* 
*/

// 1. Two phases to using a function // 
/*
* The two phases to using functions: First we must ___? Next we 
...
// 5. Inputs & Outputs//
/*
* Functions can OPTIONALLY take inputs, and OPTIONALLY return a 
...
/*
* Scope: Functions can see and modify variables in parent or 
